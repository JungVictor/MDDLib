 ...
 */
public class SetOfNode<E extends AbstractNode> implements MemoryObject, CollectionOf<E> {
    ...
    public SetOfNode(MemoryPool<SetOfNode<E>> pool){
        this.pool = pool;
    }
     ...
     */
    public void add(SetOfNode<E> set){
     ...
     */
    public void intersect(SetOfNode<E> set){
