...
public abstract class UnorderedListOf<E> implements Allocable, Iterable<E> {

    // Index in Memory
    private final int allocatedIndex;

    private final UnorderedListOfIterator iterator = new UnorderedListOfIterator();
    private int size;
    ...
    //           INITIALISATION             //
    //**************************************//
    protected UnorderedListOf(int allocatedIndex){
    ...
    private class UnorderedListOfIterator implements Iterator<E> {
