...
public abstract class ListOf<E> implements Allocable, Iterable<E> {

    // Index in Memory
    private final int allocatedIndex;

    private final OrderedListOfIterator iterator = new OrderedListOfIterator();
    private int size;
    ...
    //           INITIALISATION             //
    //**************************************//
    protected ListOf(int allocatedIndex){
    ...
    private class OrderedListOfIterator implements Iterator<E> {
