...
public abstract class SuccessionOfAbstractNode<E extends AbstractNode> implements Iterable<E>, Allocable {
    ...
    public SuccessionOfAbstractNode(int allocatedIndex){
     ...
     */
    public void copy(SuccessionOfAbstractNode<E> array){
